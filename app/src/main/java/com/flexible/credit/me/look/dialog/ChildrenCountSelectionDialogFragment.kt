...
import com.flexible.credit.me.look.adapter.dialog.ChildrenAdapter
...
class ChildrenCountSelectionDialogFragment : DialogFragment() {
    ...
    private lateinit var jobTypeAdapter: ChildrenAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        jobTypeAdapter = ChildrenAdapter(sexTypes) { selectedType ->
